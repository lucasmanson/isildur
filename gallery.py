...
# Ajustar tamaño de la ventana para imágenes más grandes
...
# Constante para el tamaño de las miniaturas
THUMB_SIZE = 200

for i in range(4):
    lbl = tk.Label(root, text=f"Imagen {i+1}", bg="lightgray")
    lbl.place(x=250 + (i % 2) * (THUMB_SIZE + 20),
              y=20 + (i // 2) * (THUMB_SIZE + 20))
...
def mostrar_imagenes(event):
    ...
    for i in range(4):
        ...
        if i < len(imagenes):
            ...
            # Redimensionar la imagen para que sea más grande
